...
VERSION='boris-topics-v18-conference-and-generic-growth-gates-072'
...
def prepare(db,s3,run_id):
    ...
    coverage={'clustering_method':'complete_linkage_cosine',
      ...
      'calibration_status':'Known v4-v17 false-positive patterns separated in tests; targeted sample only, not a general benchmark',
